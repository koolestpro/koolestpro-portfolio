...
<!--
  ...
  BUILT:    [Date]
  EDIT:     See CLAUDE.md → Editing Guide for how to modify this file
-->
```
...
##
For any part that requires image generation, I now have gpt image in terminal, you can run the prompt needed for whatever images check gpt-image skill
